...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        """
        self.conv_in = Conv2DExtendedChannels(
            in_channels,
        ...
        """
        self.conv_out = Conv2DExtendedChannels(
            block_out_channels[0],
            out_channels,
            kernel_size=conv_out_kernel,
            padding=conv_out_padding,
            out_channel_extension=2 if use_channel_expansion else 0,
        )
    ...
    def forward(
        ...
        if encoder_hidden_states.shape[1] > 77:
            ...
            if self.config.use_repeat_context_img:
